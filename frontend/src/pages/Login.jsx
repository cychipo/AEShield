    ...
    <div className="login-page">
      <div className="login-container">
        <div className="brand-identity">
          ...
          <h1>AEShield</h1>
          <p>Cổng bảo mật cấp doanh nghiệp</p>
        </div>

        <div className="login-card">
          <div className="login-header">
            <h2>Đăng nhập</h2>
            <p>Xác thực để truy cập bảng điều khiển an toàn</p>
          </div>
        ...
        <div className="footer-info">
          ...
          <p className="terms">
            Bằng việc đăng nhập, bạn đồng ý với <a href="/terms">điều khoản dịch vụ</a> của chúng tôi.
          </p>
        </div>
      </div>
    </div>
