    ...
    <div className="bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-6 font-display">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-charcoal dark:text-slate-100 tracking-tight">AEShield</h1>
          <p className="text-charcoal/60 dark:text-slate-400 mt-2 text-center text-sm">Cổng bảo mật cấp doanh nghiệp</p>
        </div>

        {/* Login Card */}
        <div className="bg-surface dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm p-8">
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-charcoal dark:text-slate-100">Đăng nhập</h2>
            <p className="text-charcoal/60 dark:text-slate-400 text-sm mt-1">Xác thực để truy cập bảng điều khiển an toàn</p>
          </div>
        ...
        <div className="mt-8 text-center space-y-4">
          ...
          <p className="text-charcoal/40 dark:text-slate-600 text-[11px] leading-relaxed max-w-[280px] mx-auto">
            Bằng việc đăng nhập, bạn đồng ý với <a href="/terms" className="text-primary hover:underline">điều khoản dịch vụ</a> của chúng tôi.
          </p>
        </div>
      </div>
    </div>
