    ...
    <div className="flex h-screen overflow-hidden bg-background-light dark:bg-background-dark">
      ...
      <aside className="w-64 border-r border-primary/10 bg-white dark:bg-slate-900 flex flex-col">
        ...
        <nav className="flex-1 px-4 space-y-1">
          ...
          <a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary font-medium" href="/files">
            <FolderOpen size={20} />
            <span>Tệp tin</span>
          </a>
        ...
        <div className="flex-1 overflow-y-auto p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-primary/10 shadow-sm p-6 text-center">
              ...
              <h3 className="text-lg font-medium text-slate-700 dark:text-slate-300 mb-2">Chưa có tệp tin nào</h3>
              <p className="text-slate-500 dark:text-slate-400 mb-4">Tải lên tệp tin đầu tiên của bạn để bắt đầu mã hóa và bảo vệ dữ liệu.</p>
