...
import {
  Shield, LayoutDashboard, FolderOpen, UserCheck, Settings as SettingsIcon,
  Search, Bell
} from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-background-light dark:bg-background-dark">
      ...
      <aside className="w-64 border-r border-primary/10 bg-white dark:bg-slate-900 flex flex-col">
        ...
        <nav className="flex-1 px-4 space-y-1">
          ...
          <a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary font-medium" href="/settings">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-primary/10 shadow-sm p-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Ảnh đại diện</label>
                  <div className="flex items-center gap-4">
                    <div
                    ...
                    ></div>
                    <button className="text-primary hover:underline text-sm">Thay đổi ảnh</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Thay đổi mật khẩu tài khoản của bạn</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Thêm lớp bảo vệ bổ sung cho tài khoản</p>
                  </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-red-200 dark:border-red-800 shadow-sm p-6">
              <h2 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-4">Khu vực nguy hiểm</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
